...
function App() {
  ...
  useEffect(() => {
    ...
    axios('https://ipapi.co/json/').then((response) => response.data).then((data) => {
      console.log(data) 
      ...
      <div className={ismorning ? "box day" : "box night"}>
        <div className={show ? "activepositioner" : "positioner"}>
          ...
          <div className="display">
            ...
            <div className={show ? "showntime" : "time"}>
              <div className="welcomer">
                <p> <img src={ismorning ? sun : moon}/>{ismorning ? 'GOOD MORNING' : 'GOOD EVENING'} IT'S CURRENTLY</p>
              </div>
              <div className="clock">
                <p>{time}</p>
              </div>
          ...
          <div className="clicker">
            <button onClick={() => {
              setShow(!show);
            }} > {show ? "LESS" : "MORE"}         <div className="btnimg"><img src={show ? up : down}/></div></button>
          </div>
          </div>
        </div>
        ...
        <div className="floors"> 
         <div className="side"><label>CURRENT TIMEZONE</label> <p>{location}</p></div>
         <div className="side"><label>DAY OF THE YEAR</label> <p>{year}</p></div>

        </div>
        <div className="floors"> 
        <div className="side"><label>DAY OF THE WEEK </label> <p>{week}</p></div>
         <div className="side"><label>WEEK NUMBERS </label> <p>{weekpassed}</p></div>
         </div>
